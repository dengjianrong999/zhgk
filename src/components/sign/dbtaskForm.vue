...
<template>
    <div class="main">
        <div class="block">
            ...
            <div class="value">
			    <el-select filterable placeholder="--请选择--"  v-model="type" :disabled="disabledFlag">
        ...
        <div class="block">
            ...
            <div class="value">
				...
				<input class="myinput" placeholder="--请选择会签日期--" v-model="signtime" readonly="readonly" id="signTime1" :disabled="disabledFlag">
            </div>
        </div>
        <div class="remark">
            <div class="name">
            ...
            <div class="value">
				<input class="myinput" v-model="title" :disabled="disabledFlag">
            </div>
        </div>
        <div class="remark">
            <div class="name">
            ...
            <div class="value">
				<textarea class="myinput" v-model="describe" :disabled="disabledFlag"></textarea>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            saves() {
                ...
                _this.$http({
                    url:_this.baseurl+"zhgkhq/saveAndExamine?userIds="+userIds,
                    method:"post",
                    data:paramData,
                    // paramData:{userIds:_this.userList}
                }).then(function (res){
                    if(res.status===200 && res.data.status==1){
            ...
            ,openUserTree(id){
              ...
              top.layer.open({
                                    ...
                                    success: function (layero) {
                                      ...
                                      this.userList=JSON.parse(sessionStorage.getItem('UserNodes')) ;
                                      console.log(this.userList);
