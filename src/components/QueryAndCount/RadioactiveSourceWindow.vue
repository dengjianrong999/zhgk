...
<template>
    <div class="fs-window">
        ...
        <div class="block">
            ...
            <div class="value">
                <input type="text" class="myinput" :disabled="disabledFlag" v-model="belongWorkplace">
            </div>
        </div>
        <div class="block">
            <div class="name">
        ...
        <div class="block">
            ...
            <div class="value">
                ...
                <input type="text" style="background:transparent;" class="myinput" placeholder="--请选择出厂日期--" :disabled="disabledFlag" readonly="readonly" v-model="productTime"
                    id="surface1">
            </div>
        </div>
        <div class="block">
