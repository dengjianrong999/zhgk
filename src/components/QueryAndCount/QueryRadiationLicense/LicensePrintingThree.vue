...
<template>
    <div class="fs-window License-window">
        ...
        <div class="block">
            ...
            <div class="value">
                <input type="text" class="myinput" :disabled="disabledFlag" :value="!currentData?' ':currentData.WORKPLACE_NAME">
            </div>
        </div>
        <div class="block">
            <div class="name">
            ...
            <div class="value">
                <input type="text" class="myinput" :disabled="disabledFlag" :value="!currentData?' ':currentData.WORKPLACE_SITE">
            </div>
        </div>
        <div class="block">
            <div class="name">
            ...
            <div class="value">
                ...
                :value="!currentData?' ':currentData.RADIATION_NAME"
                >
            </div>
        </div>
        <div class="block">
        ...
        <div class="block">
            ...
            <div class="value">
                <input type="text" class="myinput" :disabled="disabledFlag" 
                :value="!currentData?' ':currentData.TOTAL_APPROVED_ACTIVITY">
            </div>
        </div>
        <div class="block">
            <div class="name">
  ...
  methods: {
    ...
    searchDetial() {
      ...
      if (id !== "save") {
        ...
        this.$http({
          method: "get",
          url: `${this.baseurl}unitInfo/xkzfb2/${id}`
        }).then(function(res) {
          if (res.status === 200) {
            ...
            // _this.radiationName = datas.RADIATION_NAME;
            // _this.category = datas.CATEGORY;
            // _this.activitiesType = datas.ACTIVITIES_TYPE;
            // _this.totalApprovedActivity = datas.TOTAL_APPROVED_ACTIVITY;
          }
        });
      }
    }
