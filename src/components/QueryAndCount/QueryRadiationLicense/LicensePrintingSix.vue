...
<template>
    <div class="fs-window License-window">
        ...
        <div class="block">
            ...
            <div class="value">
                <input type="text" class="myinput" :disabled="disabledFlag"
                :value="!currentData?' ':currentData.LABEL">
            </div>
        </div>
        <div class="block">
            <div class="name">
            ...
            <div class="value">
                <input type="text" class="myinput" :disabled="disabledFlag"
                :value="!currentData?' ':currentData.RADIATIONSOURCE_CODE">
            </div>
        </div>
        <div class="block">
            <div class="name">
        ...
        <div class="block">
            ...
            <div class="value">
				<i class="el-input__icon el-icon-date"></i>
                <input type="text" placeholder="--请选择--" class="myinput" :disabled="disabledFlag"
