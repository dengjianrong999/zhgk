        ...
        <div class="block">
            ...
            <div class="value">
			   <!-- <input class="myinput" v-model="outletType" > -->
                <el-select filterable placeholder="--请选择--"  v-model="outletType" :disabled="disabledFlag">
        ...
        <div class="block">
            ...
            <div class="value">
			   <!-- <input class="myinput" v-model="outwhereId" > -->
                <el-select filterable  placeholder="--请选择--"  v-model="outwhereId">
    ...
    export default {
        data() {
            return {
             ...
             outletName:"",
             outletType:"",
             outletTypeList:[{value:"废水"},{value:"污水"},{value:"重金属废水"}],
             outwhereId:"",
            //  codeWaterarea:"",
            //  monitorFactor:"",
           //  outLimit:"",
        ...
        methods: {
            ...
            saves() {
                ...
                this.$http({
                            method: 'post',
                            url: `${this.baseurl}/wrynb/outletWater/save
`,
                            data:paramData
                        })
                        .then(function (res) {
            ...
            getDetailData() {
                 ...
                 let _this = this;
                  let operateNum = JSON.parse(sessionStorage.getItem('operateNum')); // 操作类型 0详情 1修改
                    ...
                    if(id!='111'){
                        this.$http({
                            method: 'post',
                            url: _this.baseurl + "wrynb/outletWater/data/"+id ,
                        ...
                        .then(function (res) {
                         ...
                         _this.outwhereId=res.data.data.outwhereId;
                        ...
                        //  console.log(_this.standardId);
                          _this.$http({
                             url:_this.baseurl+"wrynb/outletWater/getFactorNameListByIds?factorId="+res.data.data.factorId,
                             method:'post'
                         }).then(function(res1){
                             if(res1.status==200){
                            //    console.log(res1)
                    ...
                    _this.$http({
                        method:'post',
                        url:_this.baseurl+"wrynb/company/getConpanyNameByType?type=水"
                    }).then(function(res){
             ...
             opentree(){
                 if(this.standardId==null || this.standardId==""){
                  ...
                  sessionStorage.setItem('outwhereId',_this.outwhereId);
                  sessionStorage.setItem('factorIds',_this.factorId);
                  sessionStorage.setItem('outletType',_this.outletType);
