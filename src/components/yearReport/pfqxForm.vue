...
<template>
    <div class="main">
        ...
        <!-- <div class="block">
            ...
            <div class="value">
			   <input class="myinput" v-model="executStandard" >
            </div>
        </div> -->
        <!-- <div class="block">
            <div class="name">
            ...
            <div class="value">
			  <el-select filterable placeholder="--请选择--"  v-model="checkStandard" :disabled="disabledFlag">
					<el-option v-for="item in checkStandardList" :key="item.value" :label="item.value" :value="item.value">
					</el-option>
				</el-select>
            </div>
        </div> -->
        <div class="block">
            ...
            <div class="value">
			   <input class="myinput" v-model="names" >
            </div>
        </div>
        <!-- <div class="block">
            <div class="name">
            ...
            <div class="value">
			   <input class="myinput" v-model="riverType" >
            </div>
        </div> -->
        <div class="remark">
            <div class="name">
            ...
            <div class="value">
			   <textarea class="myinput" v-model="describes" ></textarea>
            </div>
        </div>
    ...
    export default {
        data() {
            return {
             ...
             id:"",
             types:"",
             typesList:[{value:'Ⅰ类水'},{value:'Ⅱ类水'},{value:'Ⅲ类水'},{value:'Ⅳ类水'},{value:'Ⅴ类水'}],
            executStandard:"",
            names:"",
            riverType:"",
            describes:"",
            checkStandardList:[{value:"A级"},{value:"B级"},{value:"城镇污水处理厂"}],
            checkStandard:"",
            };
        },
        mounted() {
        ...
        methods: {
            ...
            saves() {
                ...
                let paramData={
                        ...
                        types:_this.types,
                        // executStandard:_this.executStandard,
                        names:_this.names,
                        // riverType:_this.riverType,
                ...
                this.$http({
                            method: 'post',
                            url: `${this.baseurl}/wrynb/OutwhereWater/save`,
                            data:paramData
                        })
                        .then(function (res) {
                            if (res.status === 200) {
                 ...
                 let _this = this;
                  let operateNum = JSON.parse(sessionStorage.getItem('operateNum')); // 操作类型 0详情 1修改
                    ...
                    if(id!='111'){
                        this.$http({
                            method: 'post',
                            url: _this.baseurl + "wrynb/OutwhereWater/data/"+id ,
                            
                        })
                        .then(function (res) {
                            console.log(res.data.data);
                         _this.id=res.data.data.id;
                         //_this.executStandard=res.data.data.executStandard;
                         _this.types=res.data.data.types;
                         _this.names=res.data.data.names;
                      //   _this.riverType=res.data.data.riverType;
