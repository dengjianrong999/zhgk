        ...
        <!-- <div class="block">
            ...
            <div class="value">
               ...
               <el-select filterable placeholder="--请选择--"  v-model="useTypes" :disabled="disabledFlag">
                   <el-option v-for="item in useTypeList" :key="item.value" :label="item.value" :value="item.value">
					</el-option>
               </el-select>
            </div>
        </div> -->
...
<script>
    export default {
        data() {
            ...
            // useTypes:"",
             standardId:"",
           //  useTypeList:[{value:"实测"},{value:"折算"},{value:"燃料消耗量"},{value:"其他"}],
             isTzxfactors:"",
        ...
        methods: {
            ...
            saves() {
                ...
                this.$http({
                            method: 'post',
                            url: `${this.baseurl}/wrynb/LimitFactorG/save`,
                            data:paramData
                        })
                        .then(function (res) {
                            if (res.status === 200) {
                 ...
                 let _this = this;
                  let operateNum = JSON.parse(sessionStorage.getItem('operateNum')); // 操作类型 0详情 1修改
                    ...
                    if(id!='111'){
                        this.$http({
                            method: 'post',
                            url: _this.baseurl + "wrynb/LimitFactorG/data/"+id ,
