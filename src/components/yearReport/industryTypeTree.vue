    ...
    export default {
        ...
        methods: {
            ...
            initTree(){
               ...
               _this.$http({
                    method: 'post',
                    url: _this.baseurl + "/wrynb/company/getIndustryTypeList",
               }).then(function(res){
                //    console.log(res);
               ...
               let industryTypeNode=[];
               for(var i in CheckedNodes){
                 
                       industryTypeNode.push({id:CheckedNodes[i].id,name:CheckedNodes[i].name});
                   
               }
                sessionStorage.setItem('industryTypeNode', JSON.stringify(industryTypeNode));
                this.closeIframe();
