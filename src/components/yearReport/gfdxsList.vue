	...
	<div class="fs-right">
		...
		<div class="input-box">
			<div class="input-group">
				<span class="input-group-addon">观测井名称：</span>
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th scope="col">观测井名称</th>
						<th scope="col">观测井代码</th>
		...
		methods: {
			...
			getpage() { // 按页获取数据
				...
				setTimeout(() => {
					_this.$http({
							method: 'post',
							url: `${_this.baseurl}wrynb/gfPentrant/getGfDxsList`,
							params: temData
						})
						.then(function (res) {
							if (res.status == 200 ) {
            ...
            addorUpdate(id,num){
			   ...
			   sessionStorage.setItem('operateNum', JSON.stringify(num));
			    let layerIndex = top.layer.open({
                                    ...
                                    content: _this.baseurl2+'#/gfdxsForm/'+id ,
