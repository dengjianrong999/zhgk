    ...
    <div class="main">
       ...
       <div class="block">
         ...
         <div class="block">
            ...
            <div class="value">
			   <input class="myinput" v-model="styEmissions" >
            </div>
        </div>
        <div class="block">
            <div class="name">
...
<script>
    export default {
        ...
        methods: {
            ...
            saves() {
                if(this.companyId=="" || this.factorId=="" || this.monitorDate=="" || this.styname=="" || this.monitorFactor=="" || this.standardId==""){
                    layer,msg("请填完必填项");
                    return;
                }else{
                let _this=this;
                let paramData={
                        ...
                        remark:_this.remark,
                        styEmissions:_this.styEmissions,
            ...
            opentree(){
             ...
             openSelectPage(){
                ...
                let _this=this;
                 ...
                 sessionStorage.setItem('types',"sty");
                 sessionStorage.setItem('standardId',_this.standardId);
                 top.layer.open({
                                    type: 2,
                                    title: '选择',
